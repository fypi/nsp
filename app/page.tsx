// ✅ 修复版 page.tsx
// ============ 修复清单 ============
// 1. 删除重复的 Navbar import       →  Navigation 已在 layout.tsx 中
// 2. 无其他功能性修改               →  保留原有的全屏滚动逻辑
// 3. (可选) 后续可将 data 抽到独立的 locale-data.ts 文件
...
export default function Home() {
  ...
  const locale: Locale =
    ...
    (params.locale === "en" || params.locale === "zh" || params.locale === "zh-TW")
      ? params.locale
      : "zh";

  const sections = dataMap[locale] || dataMap.zh;
