...
const content: Record<Locale, BasicPageContent> = {
  "zh": {
    "eyebrow": "公司",
    "title": "关于我们",
    "desc": "NINESPRO 是面向下一代数字产品的 AI 原生软件公司。",
    "cards": [
      {
        "title": "返回首页",
        "desc": "回到 NINESPRO 首页。",
  ...
  "zh-TW": {
    "eyebrow": "公司",
    "title": "關於我們",
    "desc": "NINESPRO 是面向下一代數位產品的 AI 原生軟體公司。",
    "cards": [
      {
        "title": "返回首頁",
        "desc": "回到 NINESPRO 首頁。",
  ...
  "en": {
    "eyebrow": "Company",
    "title": "About Us",
    "desc": "NINESPRO is an AI-native software company for next-generation digital products.",
    "cards": [
      {
        "title": "Back Home",
