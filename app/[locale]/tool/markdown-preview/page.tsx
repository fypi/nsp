...
const texts = {
  ...
  en: {
    ...
    loginRequiredDesc: "Markdown Preview is available after registration. Log in to continue.",
...
function parseInline(text: string) {
  ...
  value = value.replace(/`([^`]+)`/g, (_, code) => {
    ...
    codeTokens.push(
      `<code style="background:#f3f4f6;padding:2px 6px;border-radius:6px;font-size:0.95em;">${code}</code>`
    );
    return token;
  });
          ...
          >
            ...
            <div className="card">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: html || "<p style='color:#999;'>—</p>" }}
              />
            </div>
          </div>
        </section>
