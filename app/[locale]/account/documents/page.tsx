...
export async function generateMetadata() { return { title: "我的文书 — NinesPro" }; }
  ...
  return (
    <main style={pageShell}>
      <section style={container}>
        ...
        <h1 style={titleStyle}>我的文书</h1>
        <p style={leadStyle}>该功能将用于保存用户的我的文书。需要登录后使用，后续接入 Supabase 数据表。</p>
