...
const megaData = {
 ...
 tool: {
 cards: [
 { zh: "效率工具", en: "Productivity", tw: "效率工具" } },
...
export default function Navbar() {
 ...
 // 🔧 修复：SSR 期间不再 return null，始终渲染导航栏骨架
 // 用户相关按钮在未 mount 时显示占位符，避免布局跳动
